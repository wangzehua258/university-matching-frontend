...
import { MapPin, DollarSign, GraduationCap, Briefcase, Globe, Clock, FileText, AlertCircle, Lightbulb, ArrowLeft } from 'lucide-react';
...
interface AUResultData {
  id: string;
  user_id: string;
  targetCountry: string;
  recommendedSchools: AUSchool[];
  fallbackInfo?: {
    applied: boolean;
    steps: string[];
  };
...
export function AUResultView({ result }: { result: AUResultData }) {
  return (
          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <h1 className="ml-2 text-xl font-bold text-gray-900">澳洲大学推荐报告</h1>
              </div>
            </div>
            <button
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-lg shadow-lg p-5 text-white mb-6">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-purple-100 text-sm">包括：详细申请时间表、材料准备清单、奖学金申请指导、一对一专业顾问30分钟免费诊断等</p>
                </div>
                <a 
                  href="https://bjcn4oqknuy.typeform.com/to/XZPDqGoN" 
                  target="_blank" 
...
function AUSchoolCard({ school, rank }: { school: AUSchool; rank: number }) {
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      {/* 学校头部信息 */}
