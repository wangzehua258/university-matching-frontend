...
import { MapPin, DollarSign, GraduationCap, Briefcase, Clock, FileText, AlertCircle, BookOpen, Globe } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-900">UCAS申请时间</p>
                <p className="text-sm text-gray-600">{result.keyInfoSummary.ucasInfo}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <BookOpen className="w-5 h-5 text-purple-600 mt-1" />
              <div>
                <p className="font-medium text-gray-900">Foundation路线</p>
                <p className="text-sm text-gray-600">{result.keyInfoSummary.foundationInfo}</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Briefcase className="w-5 h-5 text-orange-600 mt-1" />
              <div>
                <p className="font-medium text-gray-900">工作签证</p>
