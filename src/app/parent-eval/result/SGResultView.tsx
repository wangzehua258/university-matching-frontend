      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 text-sm">Tuition Grant (TG)</p>
                    <p className="text-xs text-gray-600 mt-1">{result.keyInfoSummary.tgInfo}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Clock className="w-5 h-5 text-purple-600 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900 text-sm">申请时间</p>
                    <p className="text-xs text-gray-600 mt-1">{result.keyInfoSummary.applicationTiming}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Building2 className="w-5 h-5 text-orange-600 mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900 text-sm">签证信息</p>
            ...
            {/* 专业建议 - 放在显眼位置 */}
            <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-lg shadow-lg p-6 border border-green-200">
              <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
